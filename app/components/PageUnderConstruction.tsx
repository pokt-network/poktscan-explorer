  ...
  return (
    <div className={"px-3 py-5 md:px-4 gap-4 flex h-[calc(100dvh-53px-57px-70px)] flex-col"}>
      ...
      <div className={'w-full h-full flex flex-col items-center justify-center'}>
        <HardHat className={'w-16 h-16 stroke-1 mt-[-150px] mb-[-10px] text-[#6898ff]'}/>
        <div className={' flex flex-row items-center gap-4'}>
          <Hammer className={'text-[--secondary] w-14 h-14 stroke-1 rotate-[-10deg]'}/>
          <div>
            <p className={'font-medium text-2xl sm:text-4xl tracking-wide text-center mt-2'}>Page Under Construction</p>
          </div>
