...
const transactionsByAddressDocument = gql`
...
export default function TransactionByAddressTable({address, page, itemsPerPage, basePath, filter: activeFilter}: TransactionTableProps) {
  ...
  }, [page, itemsPerPage, address, activeFilter])

  const { data, error, isLoading, refetch } = useFetchOnBlock({
    query: transactionsByAddressDocument,
    variables,
    initialResult: null as unknown as DocumentNodeData<typeof transactionsByAddressDocument>,
    initialError: false
  })
